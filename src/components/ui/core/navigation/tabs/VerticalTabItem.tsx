          ...
          <Link key={name} href={href} {...linkProps}>
            <a
              ...
              className={classNames(
                ...
                "group flex min-h-9 flex-row rounded-md px-3 py-[10px] hover:bg-gray-100 group-hover:text-gray-700 [&[aria-current='page']]:bg-gray-200 [&[aria-current='page']]:text-gray-900",
            ...
            >
              ...
              <div className="h-fit">
                <span className="flex items-center space-x-2">
                  <p className="min-h-4 max-w-36 truncate">{name}</p>
